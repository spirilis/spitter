...
* WebhookServer
  ...
  * spitter_webhook_requests_successful - how many Alertmanager webhooks have we processed, attempted to route and were successful (the destination answered with a 2xx status)
